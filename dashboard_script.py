...
language_counts = pd.DataFrame(data['language'].value_counts()).rename(columns={'language': 'language_count'})
top_10_languages = language_counts.head(10).sort_values(by='language_count', ascending=True)  
plt.figure(figsize=(10, 8)) 
plt.barh(top_10_languages.index, top_10_languages['language_count'],color = '#20b0cf', edgecolor = '#0e4551')  
